...
<head>
    ...
    <title>Daftar Member - GOR Jimmy</title>
...
<body class="hold-transition register-page">
    ...
    <div class="register-box">
        <div class="card">
            ...
            <div class="card-body">
                <p class="register-box-msg">Lengkapi data diri Anda untuk bergabung</p>
                <form action="{{ route('proses.register') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="tel" name="whatsapp" class="form-control" placeholder="No WhatsApp (Aktif)" required value="{{ old('whatsapp') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
