        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Manajemen Lapangan</h3>
                </div>
                <div class="card-body">
                    <form method="GET" action="{{ route('lapangan.index') }}" class="mb-4 filter-form">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12 mb-2">
                                <div class="form-group d-flex">
                                    ...
                                    <a href="{{ route('lapangan.index') }}" class="btn btn-secondary btn-sm mr-2">
                                        <i class="fas fa-redo"></i> Reset
                                    </a>
                                    <div class="ml-auto">
                                        <span class="badge badge-light">Total: {{ $lapangan->total() }} Lapangan</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @forelse($lapangan as $l)
                                    <tr>
                                        <td>{{ ($lapangan->currentPage() - 1) * $lapangan->perPage() + $loop->iteration }}
                                        </td>
                                        <td class="font-weight-bold">{{ Str::limit($l->nama, 30) }}</td>
                                        <td>{{ $l->deskripsi }}</td>
                                        <td>
                                            <div class="btn-action-group">
                                                <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#edit{{ $l->id }}" title="Edit">
                                                    <i class="fas fa-edit"></i> <span class="d-none d-md-inline">Edit</span>
                                                </button>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#hapus{{ $l->id }}" title="Hapus">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-4">
                                            <div class="text-muted">
                                                <i class="fas fa-table-tennis fa-2x mb-3"></i>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" placeholder="Masukkan nama lapangan" class="form-control"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="4"
                            placeholder="Masukkan deskripsi lapangan" required></textarea>
                    </div>
                </div>
...
@foreach($lapangan as $l)
    <div class="modal fade" id="edit{{ $l->id }}">
        <div class="modal-dialog modal-lg-custom">
            <div class="modal-content">
                <form action="{{ route('lapangan.update', $l->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
            ...
            <div class="modal-content">
                <form action="{{ route('lapangan.destroy', $l->id) }}" method="POST">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <h5 class="text-danger font-weight-bold">{{ $l->nama }}</h5>
